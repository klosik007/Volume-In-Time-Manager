...
public class EditRule extends AppCompatActivity implements IAddRule, IEditRule{
    ...
    private View.OnClickListener showTimePicker = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            timePicker = new TimePickerDialog(EditRule.this,
    ...
    public void addRuleButton(View view){
        ...
        JSONFilesHandler json = new JSONFilesHandler(EditRule.this);
    ...
    public void loadItemsFromId(int idToEdit, String json){
        String timeFrom, timeTo, daysOfWeek, spinnerChoice;
        Spinner behaviorSpinner = (Spinner)findViewById(R.id.behaviorSpinner);
        ...
        try{
            ...
            JSONObject rule = obj.getJSONObject(idToEdit);
            ...
            behaviorSpinner.setSelection(Integer.parseInt(spinnerChoice));
